...
##### 1.3 Fig3A (uppper) and sFig3A (uppper) #####
{
...
new_meta <- readRDS('/remote-home/yanzijun/CRU/ped_M/res_ALL/TCAsubtype_new/subtype_info.RDS')
...
##### 2.1 Fig3A (lower pannel) and sFig3A (lower pannel) #####
...
##### 3.1 Fig3B and sFig3B: barplot of ratio of celltype ####
{
...
##### 3.2 Fig3C and sFig3C.boxplot of TCA cycle score #####
