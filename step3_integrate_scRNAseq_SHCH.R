#### Integration Caron et al. (GSE132509) and Thillo et al.(nc2021) and SHCH cohort
rm(list=ls())
library(Seurat)
library(dplyr)
library(ggplot2)
...
#### step1. mapping celltype for SHCH cohort used merged scRNAseq(Caron et al.and Thillo et al. as reference ####
pbmc_ref <- readRDS('/remote-home/yanzijun/CRU/Metabolism_ALL/res_ALL/Seurat/pbmc_GSE_nc.RDS')
...
### use the same UMAP as reference
